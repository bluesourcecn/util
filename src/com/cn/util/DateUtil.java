...
public class DateUtil {
    private static final Logger logger = LoggerManager.getLogger(DateUtil.class);
    ...
    /**
     * 日期格式，年月日时分秒毫秒，年月日用横杠分开，时分秒用冒号分开 秒与毫秒用空格分开 例如：2005-05-10 23：20：00
     * 000，2008-08-08 20:08:08 000
     */
    public static final String DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS_MS = "yyyy-MM-dd HH:mm:ss S";
    ...
    public static void main(String[] args) {
        String time = parseDateToStr(new Date(), DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS_MS);
